# syfi — Agent-Assisted Track

Submission repo for team **syfi** in the [MLSys 2026 FlashInfer Kernel Generation Contest](http://mlsys26.flashinfer.ai/), **agent-assisted** approach.
